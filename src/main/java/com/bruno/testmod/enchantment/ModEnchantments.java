package com.bruno.testmod.enchantment;

import com.bruno.testmod.TestMod;
import com.bruno.testmod.enchantment.custom.LightningStrikerEnchantmentEffect;
...
public class ModEnchantments {
    ...
    public static void bootstrap(BootstrapContext<Enchantment> context) {
        ...
        // go to definition -> enchantmentdefinition and see options
        // exclusive with can for example define silk touch not working with other enchantment
